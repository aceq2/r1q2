...
cvar_t	*cl_strafeColorCenter;
cvar_t	*cl_strafeColorAccel;
cvar_t	*cl_strafeColorOptimal;
...
//	cl_minfps = Cvar_Get ("cl_minfps", "5", 0);
	...
	gl_fog_r = Cvar_Get("gl_fog_r", "0.5", CVAR_ARCHIVE);
	gl_fog_g = Cvar_Get("gl_fog_g", "0.5", CVAR_ARCHIVE);
	gl_fog_b = Cvar_Get("gl_fog_b", "0.5", CVAR_ARCHIVE);
	gl_fog_a = Cvar_Get("gl_fog_a", "0.7", CVAR_ARCHIVE);
	gl_fog_density = Cvar_Get("gl_fog_density", "0.002", CVAR_ARCHIVE);
	gl_fogstart = Cvar_Get("gl_fogstart", "1", CVAR_ARCHIVE);
	gl_fogend = Cvar_Get("gl_fogend", "2000", CVAR_ARCHIVE);
	...
	cl_strafeColorCenter = Cvar_Get("cl_strafecolorcenter", "3", CVAR_ARCHIVE); //center
	cl_strafeColorAccel = Cvar_Get("cl_strafecoloraccel", "197", CVAR_ARCHIVE); //accelerating
	cl_strafeColorOptimal = Cvar_Get("cl_strafecoloroptimal", "193", CVAR_ARCHIVE); //optimal
